                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($cate_pro->category_status == 1)
                                        <a
                                            href="{{ URL::to('/unactive-category-product?category_id=' . $cate_pro->category_id) }}">
                                            <i style="color: rgb(52, 211, 52); font-size: 30px"
                                                class="mdi mdi-toggle-switch"></i>
                                        </a>
                                    @else
                                        <a
                                            href="{{ URL::to('/active-category-product?category_id=' . $cate_pro->category_id) }}"><i
                                ...
                                <td>
                                    <a href="{{ URL::to('/edit-category-product?category_id=' . $cate_pro->category_id) }}">
                                        <i style="font-size: 20px" class="mdi mdi-lead-pencil"></i>
                                    </a>
                                    <a onclick="return confirm('Bạn muốn xóa danh mục này không?')"
                                        href="{{ URL::to('/delete-category-product?category_id=' . $cate_pro->category_id) }}"
