          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6 class="font-weight-light">Hãy nhập Tài Khoản hoặc Email bạn từng đăng ký !</h6>
                <form class="pt-3" action="{{ URL::to('find-account-recovery-pw') }}" method="post">
                  {{ csrf_field() }}
                  <div class="form-group">
                    <input type="text" name="customer_name_mail" class="form-control form-control-lg" id="" placeholder="Nhập Tên Tài Khoản Hoặc Email">
                  </div>

                  <div class="mt-3">
                    <input type="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" value="Tìm Kiếm">
                  </div>
                </form>
              </div>
            </div>
