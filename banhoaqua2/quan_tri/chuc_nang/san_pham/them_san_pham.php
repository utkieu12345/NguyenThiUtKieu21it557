...
<form action="" method="post" enctype="multipart/form-data">
	<table width="990px">
		...
		<tr>
			...
			<td>
				<?php
				if (!isset($_SESSION['danh_muc_menux'])) {
					$_SESSION['danh_muc_menux'] = "";
				}
				?>
				<select name="danh_muc" style="margin-top:3px;margin-bottom:3px;">
					...
					while ($tv_2 = mysqli_fetch_array($tv_1)) {
						$ten = $tv_2['ten'];
						$id_menu = $tv_2['id'];
						if ($_SESSION['danh_muc_menux'] == $id_menu) {
							$a = "selected";
						}
		...
		<tr>
			...
			<td>
				...
				$a_1 = "";
				$a_2 = "";
				if (isset($_SESSION['tuy_chon_trang_chux'])) {
					if ($_SESSION['tuy_chon_trang_chux'] == "co") {
						$a_2 = "selected";
					}
				}
				?>
		...
		<tr>
			...
			<td>
				...
				$a_1 = "";
				$a_2 = "";
				if (isset($_SESSION['tuy_chon_noi_batx'])) {
					if ($_SESSION['tuy_chon_noi_batx'] == "co") {
						$a_2 = "selected";
					}
				}
				?>
